...
phenotypeFactor.val = reshape(repmat (alphaList', 2, 1), prod(phenotypeFactor.card), 1);
phenotypeFactor.val(2:2:prod(phenotypeFactor.card)) = 1 - phenotypeFactor.val(2:2:prod(phenotypeFactor.card));
