...
for i=1:numPeople
    ...
    if parVar(1)*parVar(2) == 0
        ...
        factorList(i) = childCopyGivenParentalsFactor(numAlleles, i, parVar(1), numPeople+parVar(1));
        factorList(numPeople+i) = childCopyGivenParentalsFactor(numAlleles, numPeople+i, parVar(2), numPeople+parVar(2));
        factorList(2*numPeople+i) = phenotypeGivenCopiesFactor(alphaList, numAlleles, i,numPeople+i, 2*numPeople+i);
    end
end
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%  