...
phenotypeFactor.card = [2 ones(1, 2)*numAlleles];
...
for i=1:numAlleles
    for j=1:numAlleles
        indx = 1 + 2*(i-1) + (2*numAlleles)*(j-1);        
        phenotypeFactor.val(indx:indx+1) = [alphaList(allelesToGenotypes(i, j)) 1-alphaList(allelesToGenotypes(i, j))];
    end
end
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%